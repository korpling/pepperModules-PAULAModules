 ...
 *
 */
package de.hub.corpling.pepper.modules.paula.util.xPointer;

/**
 * Die Klasse XPtrRef stellt Objekte zur Verfuegung, die Informationen ueber das Refernzziel 
 ...
 * enthalten mehrere Elemente als Ziel. Ein Objekt dieser Klasse haelt dazu den id-Wert
...
//	 ============================================== �ffentliche Methoden ==============================================
	...
	/**
	 * Gibt den Namen des Dokumentes zur�ck, auf das der XPointer zeigt. Dieses Element
	 * enth�lt das Element mit der id bzw. Elemente mit linker und rechter Bereichsgrenze.
